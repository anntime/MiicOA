...
public class ContractExecuteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contract_execute);
        //获取上一页面传递的参数
    ...
    private void initView(){
        ...
        addExecuteBtn = (Button)findViewById(R.id.add_execute_btn);
    ...
    private View.OnClickListener addExecuteListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Intent intent = new Intent(ContractExecuteActivity.this, AddExecuteActivity.class);
    ...
    public void GetDetailInfo(){
        ...
        Callback<String> callback = new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if(response.body()!=null){
                    try {
                        ...
                        if(!jsonStrTemp.equals("[]")){
                            ...
                            if (accList != null&&accList.length()!=0) {
                                if(!accList.getJSONObject(0).isNull("ID") ){
                                    ...
                                    //附件
                                    contractFileAccAdapter = new ContractApprovalAccFileAdapter(ContractExecuteActivity.this, contractAccList);
                        ...
                        Toast.makeText(ContractExecuteActivity.this,ex.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                }
            ...
            public void onFailure(Call<String> call, Throwable throwable) {
                ...
                Toast.makeText(ContractExecuteActivity.this,"网络错误，请稍后再试！",Toast.LENGTH_SHORT).show();
            }
        };
                ...
                if(response.body()!=null){
                    try {
                        ...
                        if(!jsonStrTemp.equals("[]")) {
                            ...
                            executeTimeLineAdapter = new ContractExecuteTimeLineItemAdapter(executeDataList,ContractExecuteActivity.this);
                            ...
                            executeMessage.setVisibility(View.GONE);
                        }else{
                            TextView executeMessage = (TextView)findViewById(R.id.execute_message);
    ...
    public void downLoad(final String path, final String FileName,final int listPosition) {
        ...
        if(listPosition >= contractAccFileLv.getFirstVisiblePosition() &&
            ...
            requestPermission(ContractExecuteActivity.this);
            ...
            Toast.makeText(ContractExecuteActivity.this,"文件下载至："+Environment.getExternalStorageDirectory().toString() + "/OA_file",Toast.LENGTH_SHORT).show();
        }
    }
}
