...
public abstract class CalenderBaseActivity extends AppCompatActivity {
    ...
    protected abstract void initView(String[] Arr);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(getIntent().getStringExtra("clickDate")!=null&&!getIntent().getStringExtra("clickDate").equals("")){
            arr = getIntent().getStringExtra("clickDate").split("-");
