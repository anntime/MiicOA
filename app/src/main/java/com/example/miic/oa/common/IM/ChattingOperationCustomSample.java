package com.example.miic.oa.common.IM;
...
public class ChattingOperationCustomSample extends IMChattingPageOperateion {
    ...
    private static final YWIMKit myIMKit = MyApplication.mIMKit;
            ...
            if (!TextUtils.isEmpty(msgType) && msgType.equals(CustomMessageType.IMAGE)){
                ...
                if (body.getExtraData() != null && (Integer)body.getExtraData() == YWMessage.MSG_READED_STATUS){
                    ...
                    RequestPermissionUtil.requestReadSdCardPermission(fragment, new com.alibaba.wxlib.util.IWxCallback() {
                        @Override
                        public void onSuccess(Object... result) {
//                            Intent intent = add Intent(fragment.getActivity(), PreviewImageActivity.class);
...
//                            fragment.startActivity(intent);
    ...
    public boolean onMessageLongClick(final Fragment fragment, final YWMessage message) {
        ...
        if (message != null) {
            ...
            final YWConversation conversation =MyApplication.mIMKit.getConversationService().getConversationByConversationId(message.getConversationId());
...
//										String content = message.getContent();
    ...
    public String getShowName(YWConversation conversation) {
        ...
        if (conversation.getConversationType() == YWConversationType.Tribe) {
            ...
            IYWCrossContactProfileCallback callback = myIMKit.getCrossProfileCallback();
            if (callback != null) {
                ...
                IYWContactProfileCallback profileCallback = myIMKit.getProfileCallback();
            ...
            IYWContact iContact = myIMKit.getIMCore().getContactManager().getWXIMContact(userId);
            if (iContact != null && !TextUtils.isEmpty(iContact.getShowName())) {
                conversationName = iContact.getShowName();
            }
        }
    ...
    public View getCustomMessageView(Fragment fragment, YWMessage msg) {
        ...
        if (msg.getMessageBody().getExtraData() != null) {
            ...
            try{
                ...
                msg.getMessageBody().setExtraData(Html.fromHtml(data));
...
//
//    public static ISelectContactListener selectContactListener = add ISelectContactListener() {
//        @Override
...
//        YWMessageBody messageBody = add YWMessageBody();
...
//            if (convertView == null) {
//                YWLog.i(TAG, "getCustomView, convertView == null");
//                holder = add ViewHolder1();
//                convertView = add TextView(fragment.getActivity());
//                holder.greeting = (TextView)convertView;
//                LinearLayout.LayoutParams params = add LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
...
//            try {
//                String content = message.getMessageBody().getContent();
//                JSONObject object = add JSONObject(content);
...
//
//            YWIMKit imKit = MyApplication.mIMKit;
...
//                YWLog.i(TAG, "getCustomView, convertView != null");
//            }
//            if (message.getAuthorUserId().equals(myIMKit.getIMCore().getLoginUserId())){ //自己发送的消息
...
//        List<ReplyBarItem> replyBarItems = add ArrayList<ReplyBarItem>();
//
...
////                replyBarItem.setOnClicklistener(add View.OnClickListener() {
////                    @Override
...
//            ReplyBarItem replyBarItem = add ReplyBarItem();
...
//
//            ReplyBarItem replyBarItem2 = add ReplyBarItem();
...
//            replyBarItem2.setOnClicklistener(add View.OnClickListener(){
//                @Override
//                public void onClick(View v) {
//                    Activity context = pointcut.getActivity();
////                    Intent intent = add Intent(context, SelectContactToSendCardActivity.class);
...
//
//            ReplyBarItem replyBarItem3 = add ReplyBarItem();
...
//            replyBarItem3.setOnClicklistener(add View.OnClickListener(){
//                @Override
//                public void onClick(View v) {
//                    //先申请一下读写SD卡权限
//                    RequestPermissionUtil.requestReadSdCardPermission(pointcut, add com.alibaba.wxlib.util.IWxCallback() {
//                        @Override
//                        public void onSuccess(Object... result) {
//                            mConversation = conversation;
