...
//        }
    ...
    public View getCustomTitleView(final Fragment fragment,
        ...
        //TODO 重要：必须以该形式初始化view---［inflate(R.layout.**, add RelativeLayout(context),false)］------，以让inflater知道父布局的类型，否则布局**中的高度和宽度无效，均变为wrap_content
...
//            btn.setOnClickListener(add View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
//                    String conversationId = conversation.getConversationId();
//                    long tribeId = Long.parseLong(conversationId.substring(5));
//                    Intent intent = add Intent(fragment.getActivity(), TribeInfoActivity.class);
...
//                atView.setOnClickListener(add View.OnClickListener() {
//                    @Override
//                    public void onClick(View v) {
...
//                + "/alibaba/WXOPENI/云旺相册";
    ...
    public View getChattingFragmentCustomViewAdvice(Fragment fragment, Intent intent) {
        ...
        if (intent != null && intent.hasExtra("extraTribeId") && intent.hasExtra("conversationType")) {
            ...
            if (tribeId > 0 && conversationType == YWConversationType.Tribe.getValue()) {
                YWIMKit mIMKit = MyApplication.mIMKit;
                if (mIMKit == null) {
                    return null;
                }
                ...
                if (tribe != null && tribe.getMsgRecType() == YWProfileSettingsConstants.TRIBE_MSG_REJ) { //群在屏蔽的时候才显示。
                    ...
                    view.setBackgroundResource(R.color.news_detail_content);
    ...
    private void receiveTribeMsg(YWTribe tribe, final View view) {
        MyApplication.mIMKit.getIMCore().getTribeService().unblockTribe(tribe, new IWxCallback() {
            @Override
...
//            //TODO 新增项id必须从4开始
//            final YWInputViewPlugin pluginToAdd = add YWInputViewPlugin(plugin, 4);
//            plugin.setOnClickListener(add View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
...
//        replyBar.setInputEditTextRightDrawable(context.getResources().getDrawable(R.drawable.ww_chat_voice), add OnEditTextDrawableClickListener() {
//            @Override
//            public void onClick() {
