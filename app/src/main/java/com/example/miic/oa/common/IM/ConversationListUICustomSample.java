...
public class ConversationListUICustomSample extends IMConversationListUI {
    ...
    public View getCustomConversationListTitle(final Fragment fragment,
        ...
        //TODO 重要：必须以该形式初始化customView---［inflate(R.layout.**, add RelativeLayout(context),false)］------，以让inflater知道父布局的类型，否则布局xml**中定义的高度和宽度无效，均被默认的wrap_content替代
        ...
        final YWIMKit mIMKit = MyApplication.mIMKit;
...
//            YWContactHeadLoadHelper helper = add YWContactHeadLoadHelper(fragment.getActivity(), null);
//            /**
